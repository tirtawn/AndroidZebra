...
extern int
droidzebra_json_put_string(JNIEnv *env, jobject json, const char *key, const char *value);

extern jint droidzebra_json_get_int(JNIEnv *env, jobject json, const char *key);

extern char *
droidzebra_json_get_string(JNIEnv *env, jobject json, const char *key, char *buf, int bufsize);
