...
#define JNIFn(Package, Class, Fname) JNICALL Java_com_droid_##Package##_##Class##_##Fname
...
#define DROIDZEBRA_JNI_THROW(msg) { _droidzebra_throw_engine_error(env, (msg)); return; }
...
JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeJsonTest)(JNIEnv *env, jobject thiz, jobject json) {
...
JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeGlobalTerminate)(JNIEnv *env, jobject thiz) {
    DROIDZEBRA_JNI_SETUP;
    global_terminate();
    DROIDZEBRA_JNI_CLEAN;
}
...
JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeForceReturn)(JNIEnv *env, jobject thiz) {
    force_return = 1;
}

JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeForceExit)(JNIEnv *env, jobject thiz) {
    force_return = 1;
    force_exit = 1;
}
...
jobject droidzebra_RPC_callback(jint message, jobject json) {
    ...
    jmethodID mid = (*s_env)->GetMethodID(s_env, cls, "Callback",
                                          "(ILorg/json/JSONObject;)Lorg/json/JSONObject;");
    if (mid == 0) {
        DROIDZEBRA_JNI_BREAK;
...
JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetPlayerInfo)(JNIEnv *env, jobject thiz, jint _player, jint _skill,
                                           jint _exact_skill, jint _wld_skill, jint _time,
...
JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetAutoMakeMoves)(JNIEnv *env, jobject thiz, int _auto_make_moves) {
    auto_make_forced_moves = _auto_make_moves;
}

JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetSlack)(JNIEnv *env, jobject thiz, jfloat slack) {
    s_slack = slack;
    //set_slack( floor( s_slack * 128.0 ) );
}

JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetPerturbation)(JNIEnv *env, jobject thiz, jfloat perturbation) {
    s_perturbation = perturbation;
    //set_perturbation( floor( s_perturbation * 128.0 ) );
}

JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetHumanOpenings)(JNIEnv *env, jobject thiz, int enable) {
    s_human_opening = enable;
    //toggle_human_openings(s_human_opening);
}

JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetPracticeMode)(JNIEnv *env, jobject thiz, int enable) {
    s_practice_mode = enable;
}

JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetUseBook)(JNIEnv *env, jobject thiz, int enable) {
    s_use_book = enable;
}

JNIEXPORT void
JNIFn(zebra, ZebraEngine, zeSetForcedOpening)(JNIEnv *env, jobject thiz, jobject opening_name) {
    int i;
    const char *str = NULL;
...
JNIEXPORT jboolean
JNIFn(zebra, ZebraEngine, zeGameInProgress)(JNIEnv *env, jobject thiz) {
...
void _droidzebra_throw_engine_error(JNIEnv *env, const char *msg) {
    jclass exc = (*env)->FindClass(env, "com/droid/zebra/EngineError");
